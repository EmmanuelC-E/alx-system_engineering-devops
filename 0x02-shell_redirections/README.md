A compilation, showing the action of each script for the Shell I/O Redirection commands
...
9-duplicate_last_line - Wlrite a script that duplicates the last line of the file iacta. The file iacta will be in the working directory
